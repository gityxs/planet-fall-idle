...
var cnItems = {
    ...
    "purchased": "已购买",
    "heat reclamators": "热回收器",
    "increase fuel efficiency of dynamos": "提高发电机的燃油效率",
    "injecting combustible gas into the furnace helps us raise temperatures": "将可燃气体注入熔炉有助于我们提高温度",
    "techniques and tools outpost expansion": "技术和工具前哨站扩张",
    "tuyeres": "风口",
    "a new method of habitat construction promises to reduce costs": "一种新的栖息地建设方法有望降低成本",
    "prefabrication": "预制",
    "storage: +50.00% (crates)": "存储：+50.00%（板条箱）",
    "all available upgrades purchased": "已购买了所有可用的升级",
    "food/sec per colonist": "食物/每个殖民者每秒",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "arborists": "树艺师",
    "geology": "地质学",
    " base biomass consumption: ": "基础生物质消耗：",
...
var cnPostfix = {
    ...
    "\n\t\t": "\n\t\t",
    "\t": "\t",
    " ore production (gleaners)": "矿石生产（地质学家）",
    " food production (gleaners)": "食物生产（拾取者）",
    " food production (agronomists)": "食物生产（农学家）",
    " lumber production (chainsaws)": "木材生产（电锯）",
    " lumber production (arborists)": "木材生产（树艺师）",
    " lumber production (gleaners)": "木材生产（拾取者）",
    " base biomass production (gleaners)": "基础生物质生产（拾取者）",
    " base biomass consumption (heat reclamators)": "基本生物质消耗（热回收器）",
    " biomass consumption (tuyeres)": "生物质消耗（风口）",
    " base biomass production (composting drums)": "基础生物质生产（堆肥桶）",
    "": "",
    "": "",
}
